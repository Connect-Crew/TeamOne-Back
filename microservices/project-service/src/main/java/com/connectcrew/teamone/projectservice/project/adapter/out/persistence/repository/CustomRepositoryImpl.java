...
public class CustomRepositoryImpl implements CustomRepository {
    ...
    @Override
    public Flux<ProjectCustomEntity> findAllByOption(ProjectOption option) {
        /* 예시 SQL
        SELECT p.*,
        ...
        optionSql.add(String.format("p.state != '%s'", ProjectState.DELETED.name())); // 삭제된 프로젝트는 검색되지 않도록 함.
